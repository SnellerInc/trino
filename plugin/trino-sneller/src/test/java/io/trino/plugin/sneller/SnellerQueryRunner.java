...
public final class SnellerQueryRunner
{
            ...
            throws Exception
    {
        ...
        DistributedQueryRunner queryRunner = (DistributedQueryRunner) createSnellerQueryRunner(
                ImmutableMap.of("http-server.http.port", "8080"),
                ImmutableMap.of());

        Logger log = Logger.get(SnellerQueryRunner.class);
